(() => {
  ...
  function renderHome() {
    ...
    const added = [...records].filter(record => latestChangeDate(record, 'added')).sort((a, b) => latestChangeDate(b, 'added').localeCompare(latestChangeDate(a, 'added')) || relevance(b) - relevance(a));
    ...
    main.innerHTML = `<section class="home-market">${homeFilterPanel(personas)}<div class="home-simple">
      ...
      ${homeShelf('Nieuw toegevoegd', '#zoeken?sort=new', added)}
